#!/usr/bin/env bash
# =============================================================================
# provision_azure.sh — Provision Azure infrastructure for the Salesforce AI Assistant
...
echo "=============================================="
echo "  Salesforce AI Assistant — Azure Provisioning"
echo "=============================================="
...
# --- Step 4: Extract outputs → .env ---
echo "📝 Extracting outputs to .env.azure..."
...
cat > "$ENV_FILE" <<EOF
# Auto-generated by provision_azure.sh — ${ENVIRONMENT} environment
